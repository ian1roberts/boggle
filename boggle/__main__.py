...
parser.add_argument(
    "-m", "--maxwordlength", help="Maximum wordlength to search for in grid.", default=9
)
parser.add_argument(
    "-g",
    "--graph",
...
parser.add_argument(
    "-f", "--filename", help="Output filename", default="boggle_words.tsv", type=str
)
parser.add_argument(
    "-w",
    "--overwrite",
...
parser.add_argument(
    "-i", "--dictionary", default=None, help="Dictionary file to use.", type=str
)
